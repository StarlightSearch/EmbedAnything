use embed_anything::{
    chunkers::{cumulative::CumulativeChunker, statistical::StatisticalChunker}, embeddings::local::jina::JinaEmbeder,
...
// get first 1000 character
    let text = text.chars().take(20000).collect::<String>().remove_leading_spaces().remove_empty_lines().remove_trailing_spaces();
